...
public class MainActivity extends AppCompatActivity { EditText etNama;
    TextView etHarga;
    TextView etJumlah;
    EditText etByr; Button btTotal, btHasil, btClear;
    ...
    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState);
        ...
        etHarga= (TextView) findViewById(R.id.etHargaBarang);
        etJumlah= (TextView) findViewById(R.id.etJumlahBarang);
